...
extension String {
    ...
    static let connectionErrorMessage = NSLocalizedString("Please check the internet connection,\n%@", comment: "")
    static let retry = NSLocalizedString("try again", comment: "")
    static let noResultsErrorTitle = "There's no result"
    static let noResultsErrorMessage = NSLocalizedString("Sorry, couldn’t find\nwhat you’re\nlooking for.", comment: "")
    ...
    static let history = NSLocalizedString("Recent History", comment: "")
}
