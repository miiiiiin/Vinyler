...
class MainViewController: UIViewController {
    ...
    override func loadView() {
        ...
        [moreButton, greetingLabel, scanLabel, searchButton, animationView, vinylAnimationView].forEach(root.addSubview)
        ...
        NSLayoutConstraint.activate([
            ...
            greetingLabel.topAnchor.constraint(greaterThanOrEqualTo: vinylAnimationView.bottomAnchor, constant: 90),
